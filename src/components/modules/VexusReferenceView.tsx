...
import {
  ...
  bibliography,
  vexusSectionNav,
} from "@/lib/modules/vexus-reference";
    ...
    <div style={{ maxWidth: 720, margin: "0 auto" }}>
      <header style={{ marginBottom: 20, paddingBottom: 4 }}>
        ...
        <p style={{ ...type.bodySm, color: theme.text.secondary, margin: "0 0 10px", fontSize: 12 }}>
          {vexusHeader.subtitle}
        </p>
        <div style={{ display: "flex", flexWrap: "wrap", gap: 5, marginBottom: 10 }}>
          {vexusHeader.topicChips.map((chip) => (
      ...
      <ModuleSectionNav links={[...vexusSectionNav]} />
      ...
      <div className="ws-section-flow">
        <ModuleSection
          ...
          subtitle="Congestión venosa en UCI"
          surface="panel"
        >
        ...
        <ModuleSection id="algoritmo" eyebrow="Algoritmo" title="Algoritmo clínico" subtitle="AKI y decongestión" surface="panel">
          <AlgorithmCard steps={vexusAlgorithm} />
        </ModuleSection>
        ...
        <ModuleClinicalBlock variant="plain">
          <ModuleSection
            ...
            title="Galería Doppler"
            subtitle="Viewer tipo PACS — clic en ventana"
          >
            <VexusAtlasPanel onOpenEntry={openEntry} onNavListChange={handleNavListChange} />
          </ModuleSection>
          ...
          >
            <VexusCompareSection onOpen={openEntry} onCompare={openCompare} />
          </ModuleSection>
        </ModuleClinicalBlock>
